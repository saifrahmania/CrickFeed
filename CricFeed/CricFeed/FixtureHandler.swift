...
//
//   let fixtureHandler = try? JSONDecoder().decode(FixtureHandler.self, from: jsonData)

import Foundation

// MARK: - FixtureHandler
struct FixtureHandler: Codable {
    var data: [Datum]?
    var links: Links?
    var meta: Meta?
}
...
struct Datum: Codable {
    ...
    enum CodingKeys: String, CodingKey {
        ...
        case league, season, localteam, visitorteam, venue, stage
    }
}
...
enum UpdatedAt: String, Codable {
    case the20181022T205118000000Z = "2018-10-22T20:51:18.000000Z"
}
