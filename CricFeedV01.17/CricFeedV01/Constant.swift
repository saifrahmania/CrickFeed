...
struct Constant {
    ...
    static let rankingXib = "Ranking"
    static let squadTableCell = "SquadList"
    static let linkForLeagueWiseMatch = "https://cricket.sportmonks.com/api/v2.0/fixtures?filter[status]=Finished&include=localteam,visitorteam,league,runs&sort=season_id&api_token=mYC7mFGDBRtTMmG1Y81Ctv2TFCcf59Kab7Gr4uqBFuELTemcirhfpuLQYyzR"
    static let linkForRanking = "https://cricket.sportmonks.com/api/v2.0/team-rankings?api_token=mYC7mFGDBRtTMmG1Y81Ctv2TFCcf59Kab7Gr4uqBFuELTemcirhfpuLQYyzR"
    ...
    static let detailsAPIIncluded =  "?sort=-updated_at&include=batting.batsman,bowling.bowler,runs,scoreboards,localteam,visitorteam,stage,lineup,venue,tosswon,winnerteam&api_token=mYC7mFGDBRtTMmG1Y81Ctv2TFCcf59Kab7Gr4uqBFuELTemcirhfpuLQYyzR"
    ...
    static let infoTableCell = "InfoCell"
...
extension Constant{
    static func calculateDateDifference(dateString: String) -> String {
        ...
        let localTimezone = TimeZone(identifier: "Asia/Dhaka")!
        dateFormatter.timeZone = localTimezone
        let localDate = dateFormatter.string(from: date)
        guard let convertedDate = dateFormatter.date(from: localDate) else { return "" }
        
        let currentDate = Date()
        let difference = currentDate.timeIntervalSince(convertedDate)
    ...
    static func convertDateFormat(_ dateString: String) -> String? {
        ...
        dateFormatterOutput.timeZone = TimeZone(identifier: "Asia/Dhaka")
